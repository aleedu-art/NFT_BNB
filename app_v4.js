 ...
 * Versão 4: Correção para detecção de rede em múltiplos formatos
 */

// Configuração da API Moralis
const MORALIS_API_KEY = "19607b25-434b-43d6-9c6e-77265f7e0b3e"; // Substitua pela sua API key do Moralis
...
async function fetchNFTs() {
    ...
    if (MORALIS_API_KEY === "INSIRA_SUA_API_KEY_AQUI") {
        showAlert("Por favor, configure sua API key do Moralis no arquivo app_v4.js", "danger");
